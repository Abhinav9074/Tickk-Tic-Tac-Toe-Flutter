...
import 'package:tic_tac_toe/controller/local_controller.dart';
import 'package:tic_tac_toe/utils/theme.dart';
import 'package:tic_tac_toe/view/screens/home/home_screen.dart';

class PvpLocal extends StatelessWidget {
  const PvpLocal({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<LocalController>(
        builder: (controller) {
          return SafeArea(
            child: Column(
                        ...
                        itemBuilder: (context, index1) {
                          return GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return InkWell(
                                onTap: () {
                                  controller.player1Move(index1, index);
                                },
                                child: Padding(
